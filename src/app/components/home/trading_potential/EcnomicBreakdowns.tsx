    ...
    return (
        <Box
            sx={{
                ...
                alignItems: 'center',
                backgroundImage: 'url(/images/home/trading_potential/in_depth_ecnomic_discussion_bg.svg)',
            ...
            <Box sx={{
                ...
                <Image src={LeftPartImage} width={200} height={200} alt='exclusive member right part' />
            </Box>
            <Box sx={{
                width: {xs:"100%",lg:'50%'},
                display: 'flex',
                ...
                <Box sx={{
                    ...
                    <Typography sx={{
                        ...
                        comprehensive, detailed analysis of a particular economic subject, issue, sector, or market.
                    </Typography>
                    <Button sx={{
                        fontSize: "18px",
                        fontWeight: "500",
