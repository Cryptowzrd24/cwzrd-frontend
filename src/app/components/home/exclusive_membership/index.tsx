...
const ExclusiveMemberShip = () => {
  ...
  const isTablet = useMediaQuery(theme.breakpoints.between('sm', 'md')); // 600px - 900px
    return (
        <Box
            sx={{
                backgroundImage: 'url(/images/home/exclusive_membership/exclusive_membership_benefits_bg.svg)',
            ...
            <Box sx={{
                ...
                <Box sx={{
                    ...
                    <Image src={ShieldCheckIcon} width={24} height={24} alt='sheild check' />
                    <Box sx={{
                        display:"flex",
                        flexDirection:"column",
                        gap:"8px"
                    ...
                    <Typography sx={{
                        ...
                        Receive timely and in-depth market signals every day, ensuring you are always ahead of the curve. Our expert analysis helps you make well-informed decisions.
                    </Typography>
                    </Box>
                    <Button sx={{
                        fontSize: "18px",
                ...
                <Box>
                    <Image src={RightPartImage} width={isMobile?300:450} height={300} alt='exclusive member right part' />
                </Box>
            </Box>
        </Box>
    )
