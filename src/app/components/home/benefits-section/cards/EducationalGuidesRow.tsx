...
const EducationalGuidesRow: React.FC = () => {
  return (
    ...
    >
      ...
      <Box sx={{ position: 'relative', width: "50%", display: 'flex', alignItems: 'center', gap: { xs: '16px', sm: '20px', lg: '27.25px' }, flexWrap: { xs: 'wrap', sm: 'nowrap' }, justifyContent: { xs: 'center', lg: 'space-between' }, flexShrink: 0 }}>
