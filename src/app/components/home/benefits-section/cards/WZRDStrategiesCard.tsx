...
const WZRDStrategiesCard: React.FC = () => {
  return (
    ...
    >
      ...
      <Box sx={{ position: 'absolute', bottom: '24px', left: 0, right: 0, textAlign: 'center', px: '20px' }}>
        <Typography sx={{ color: '#7248F7', fontWeight: 700, fontSize: { xs: '20px', sm: '20px' }, lineHeight: '24px' }}>
          WZRD Strategies
        </Typography>
        <Typography sx={{ mt: '8px', color: '#111111', fontSize: { xs: '14px', sm: '16px' }, lineHeight: '17.6px' }}>
