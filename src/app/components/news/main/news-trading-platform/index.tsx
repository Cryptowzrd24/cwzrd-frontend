...
const NewsTradingPlatform = () => {
  ...
  >
    <Image
      ...
      width={305}
      height={280}
      style={{ marginBottom: '20px',overflow:"hidden",borderRadius:"18px" }}
    />
    <Stack
      sx={{
        display: 'flex',
    ...
    >
      ...
      >
        ...
        <span style={{textAlign:"center", paddingInline:"22%"}}>Mentorship</span>
      </Typography>
      ...
      <Button sx={{borderRadius:"25px",height:"40px",width:"150px", background:"rgb(243,243,243)", fontSize:"12px",fontWeight:"600",lineHeight:"15.6px"}}>Read More <span style={{color:"black", fill:"black"}}><ArrowRight fill="black" /></span></Button>
    </Stack>
  </Box>
  )
}
