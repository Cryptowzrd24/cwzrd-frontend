        ...
        >
            ...
            <div style={{ padding: "0px 8px 0px 8px", marginTop: "58px" }}>
                <div style={{ padding: "0px 8px 0px 8px" }}>
                    <Typography sx={{ fontSize: "20px", lineHeight: "26px", fontWeight: "700", color: `${staticTextColor}`, letterSpacing: "1px" }}>
                        {mainText}
                    </Typography>
                </div>

                <div style={{ padding: "0px 8px 0px 8px", marginTop: "7px" }}>
                    <Typography sx={{ fontSize: "12px", lineHeight: "15.6px", fontWeight: "400", color: `${staticTextColor}`, opacity: "0.6" }}>
                        {formatDate(date)} &nbsp; | &nbsp; {name}
                    </Typography>
                </div>
            </div>
            <Stack direction="row" style={{ marginLeft: "-6px", }}>
                <BootstrapButton variant="text" sx={{ color: `${staticTextColor}`, fontSize: "16px" }}>
