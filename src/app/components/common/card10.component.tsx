...
const Card10 = (props: ICard10Props) => {
    ...
    const { heading, staticTextColor, text1, text2, messageCount, rocketCount } = props
    ...
    const renderIconCount = (image: any, value: number, bg?: string) => {
        return (
            <Box sx={{
                ...
                width: "fit-content", background: bg ?? 'transparent',
                display: "flex",
                gap: "6px",
                ...
                <Image
                    ...
                    alt='message'
                />
                <Typography sx={{ color: "#FFFFFF", fontSize: "10px", marginTop: "1px" }}>
                    {value}
                </Typography>
            ...
            <Box className={styles.header_wrapper}>
                ...
                <Box sx={{}}>
                    ...
                    <Box sx={{ display: "flex", gap: "10px", marginTop: "10px", }} >
                        ...
                        {renderIconCount(rocketImage, rocketCount, "linear-gradient(180deg, #45CA94 0%, #97D14E 100%)")}
                    </Box>
                </Box>
            </Box>
