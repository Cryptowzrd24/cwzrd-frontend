...
const Card9 = (props: ICard9) => {
    ...
    return (
        <Card className={styles.market_cap_wrapper}
            style={{ background: "linear-gradient(to right bottom, rgb(17, 17, 17), rgb(5 6 53))" }}
        >
            ...
            <Stack direction="row" style={{ marginLeft: "20px", marginTop: "40px" }}>
                <Button variant="contained" size="small" sx={{ backgroundColor: "linear-gradient(180deg, #7248F7 0%, #BF48F7 100%)", borderRadius: "25px" }}>
