    ...
    return (
        ...
        >
            ...
            <div className={styles.header_wrapper}>
                ...
                <div style={{background: "linear-gradient(180deg, #45CA94 0%, #97D14E 100%)", mixBlendMode: "color-dodge", height: "300px", width: "300px", borderRadius: "50%", position: "absolute", opacity: "0.3"}}>
